...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Veterans Treatment Court Command";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Court Participant Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "court_participant_record_records";
'use strict';
